...
train.drop(['FireplaceQu','Id','PoolQC','Fence','Alley','MiscFeature','Utilities'],axis=1,inplace=True)
test.drop(['FireplaceQu','Id','PoolQC','Fence','Alley','MiscFeature','Utilities'],axis=1,inplace=True)
...
print(dec_tree.score(X_test,y_pred4))
